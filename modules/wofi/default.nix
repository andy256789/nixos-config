...
in {
    ...
    config = mkIf cfg.enable {
        programs.wofi = {
            ...
            style = ''
                @define-color bg-color #{${theme.utils.hexToRgba theme.colors.background theme.opacity.panel}};
                @define-color fg-color #{${theme.colors.foreground}};
                @define-color base-color #{${theme.utils.hexToRgba theme.colors.background 0.7}};
                ...
                window {
                    ...
                    border: 2px solid ${theme.utils.hexToRgba theme.colors.accent.primary 0.8};
                ...
                #input:focus {
                    border: none;
                    outline: none;
                    box-shadow: 0 0 0 2px ${theme.utils.hexToRgba theme.colors.accent.primary 0.3};
                }
                ...
                #entry:selected {
                    background: linear-gradient(90deg, ${theme.utils.hexToRgba theme.colors.accent.primary 0.9}, ${theme.utils.hexToRgba theme.colors.accent.tertiary 0.7});
